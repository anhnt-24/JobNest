		...
		<section className='relative py-16 px-4 sm:px-6 lg:px-8 bg-white mt-20'>
			<div className='relative max-w-7xl mx-auto'>
				<div className='text-center mb-12'>
					<h1 className='mb-2'>Kết Nối Với Chúng Tôi</h1>
					<p className='text-lg text-muted-foreground max-w-3xl mx-auto'>Liên hệ ngay để nhận tư vấn miễn phí hoặc đăng ký nhận tin tức mới nhất từ chúng tôi</p>
				</div>
