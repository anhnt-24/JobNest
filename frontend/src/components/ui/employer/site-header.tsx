...
import { ArrowDown, ArrowDown01, Bell, BellRing, ChevronDown, LogOut, MessageCircle, MessageCircleMore, Settings, User, UserCircle } from 'lucide-react';
					...
					<DropdownMenu>
						<DropdownMenuTrigger asChild>
							<div className='flex items-center gap-3 cursor-pointer  py-1 transition hover:bg-gray-100'>
								<Avatar className='size-12 border'>
									<AvatarImage src={user?.employer?.avatarUrl} alt='avatar' />
						...
						<DropdownMenuContent align='end' className='w-80'>
							<DropdownMenuLabel className='font-medium text-lg flex items-center gap-4'>
								...
								<div>
									<span className='font-semibold text-lg'>{user?.employer?.name}</span>
