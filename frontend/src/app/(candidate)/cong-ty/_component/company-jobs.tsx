...
export default function CompanyJobs() {
	return (
		<Card>
			...
			<Card className='hover:shadow-md transition-shadow border hover:border-primary '>
				<div className='space-y-2'>
					<div className='flex gap-2 items-start'>
						...
						<div className='flex-1 space-y-2'>
							<div className='flex justify-between '>
								...
								<p className='text-primary text-lg font-semibold  mt-2'>30 - 60 triệu</p>
							</div>
					...
					<div className='flex flex-wrap items-center gap-2 pt-2 justify-between'>
						...
						<div className='flex gap-2 justify-center'>
							<Button className='rounded-full'>Ứng tuyển ngay</Button>
							<button className='rounded-full border border-primary hover:bg-primary/5 cursor-pointer text-primary size-10 p-2'>
