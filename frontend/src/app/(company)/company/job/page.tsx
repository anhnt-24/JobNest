				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
						<div className='flex gap-6'>
							<div className=' space-y-6 items-start bg-white p-6 rounded-2xl overflow-hidden border flex-1 '>
								<FormField
							...
							<div className='border gap-6 flex-1 p-6 bg-white rounded-2xl space-y-6'>
								<FormField
									control={form.control}
									name='categories'
									render={({ field }) => (
