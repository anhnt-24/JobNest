	...
	return (
		<div className='space-y-2'>
			...
			<div className='flex gap-2'>
				...
				/>
				<Button type='button' className='bg-green-600 text-white' onClick={() => add(draft)}>
				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
						<div className='flex gap-6'>
							<div className=' space-y-6 items-start bg-white p-6 rounded-md border flex-1 '>
								<FormField
									control={form.control}
									name='title'
									render={({ field }) => (
										<FormItem className='grid-cols-5'>
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className='grid-cols-5'>
											...
											<Input className='col-span-4' {...field} placeholder='VD: 6 năm+'></Input>
											<FormMessage />
										</FormItem>
									)}
								/>
									...
									render={({ field }) => (
										<FormItem className='grid-cols-5'>
											...
											<Popover>
												<PopoverTrigger asChild>
													<FormControl className='col-span-4'>
														<Button variant={'outline'} className={cn('pl-3 border-gray-300 ', !field.value && 'text-muted-foreground')}>
							...
							<div className='border gap-6 flex-1 p-6 bg-white rounded-sm space-y-6'>
								<FormField
									control={form.control}
									name='categories'
									render={({ field }) => (
						...
						<div className='grid grid-cols-2  rounded-sm gap-6'>
							<FormField
								control={form.control}
								name='description'
								render={({ field }) => (
